...
class CalculatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculator" do
    assert_difference("Calculator.count") do
      post calculators_url, params: { calculator: { body_weight: @calculator.body_weight, goal_weight: @calculator.goal_weight, protein: @calculator.protein } }
    end
  ...
  test "should update calculator" do
    patch calculator_url(@calculator), params: { calculator: { body_weight: @calculator.body_weight, goal_weight: @calculator.goal_weight, protein: @calculator.protein } }
